...
# To run:
# python preactTrainer.py --dataset_type cifar10 --network_type resnet --num_layers 8 8 8 --resume False --update_rule momentum --momentum_params 0.1 0.9 --l2_reg 1e-4 --num_epochs 100 --train_batchsize 64 --epoch_decay 50 75 --exp_dir /data/milatmp1/jojason/resnet_test/
...
if args.network_type == 'resnet':
	model = ResNet(block=PreactBlock, layers=args.num_layers)
